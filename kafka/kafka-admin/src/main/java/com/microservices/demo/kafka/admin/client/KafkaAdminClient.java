...
public class KafkaAdminClient {
    ...
    private void checkMaxRetry(int retry, Integer maxRetry){
        if(retry > maxRetry) throw new KafkaClientException("Reached Max retries for reading kafka topic(s)");
    }
    ...
    private Collection<TopicListing> getTopics(){
        ...
        try {
            ...
            throw new KafkaClientException("Reached max retries while reading kafka topic(s)", t);
        }
        return topics;
    }
